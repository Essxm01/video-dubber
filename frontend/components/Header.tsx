...
import { Globe, Menu, X, Sun, Moon, LogIn, User as UserIcon, Settings } from 'lucide-react';
          ...
          {user && (
            <>
              ...
              <button
                ...
                className="mx-1 px-4 py-2 text-base font-bold text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-all flex items-center gap-1"
              >
            ...
            {user && (
              <>
                ...
                <button
                  ...
                  className="px-4 py-3 text-start font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl flex items-center gap-2"
                >
                  <Settings className="w-4 h-4" />
                  {t.settings || 'الإعدادات'}
                </button>
